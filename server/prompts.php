...
function getIntroPrompt($writing, $feedbackType) {
    ...
    paragraphs. Provide specific feedback in which you detail at least 5 specific ways the student could improve the 
...
function getBodyPrompt($writing, $feedbackType) {
    ...
    research paper. Provide specific feedback in which you detail at least 5 specific ways the student could improve their
    ...
    writing, even to show as an example. Here is the body of the paper: " . $writing;
}
...
function getConclusionPrompt($writing, $feedbackType) {
    ...
    an example. Here is the conclusion: " . $writing;
}
